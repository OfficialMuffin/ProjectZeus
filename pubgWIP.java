...
public class pubgWIP {
    public static void main(String[] args) {
        ...
        int assaultAttackDamage = 25;
        int smgAttackDamage = 15;
        int sniperAttackDamage = 35;
        int semiAutoSniperAttackDamage = 45;
        ...
        int medkitDropChance = 10; //Percentage
        ...
        while (running) {
            ...
            while (enemyHealth > 0) { //While enemy is alive
                ...
                System.out.println("\t3. Keep Running");

                String input = in.nextLine();
                if(input.equals("1")) {
                    int damageDealt = rand.nextInt(attackDamage);
                    int damageTaken = rand.nextInt(assaultAttackDamage);
